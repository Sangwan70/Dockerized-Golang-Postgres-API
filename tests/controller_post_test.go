...
func TestUpdatePost(t *testing.T) {
	...
	samples := []struct {
		...
		{
			//Note: "Alliance Software Technology" belongs to post 2, and title must be unique
			id:           strconv.Itoa(int(AuthPostID)),
			updateJSON:   `{"title":"Alliance Software Technology", "content": "This is the updated content", "author_id": 1}`,
			statusCode:   500,
			tokenGiven:   tokenString,
			errorMessage: "Title Already Taken",
		},
